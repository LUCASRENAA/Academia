...
def gerarDados(host,user,password):
        ...
        texto = """
        INSERT INTO ACADEMIA (ID_GROUP, NomeAcademia, quantidadeAlunos, lotacao, Endereco, Dono) VALUES(1, "Forca", 0, 30, "Rua teste", "Lucas");
